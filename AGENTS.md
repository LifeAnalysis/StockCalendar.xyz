...
- `lib/` for Robinhood Chain, Nuvolari/Arqsy, Kalshi, calendar, env, and HTTP helpers.
...
- If adding Nuvolari or Arqsy API paths, prefer explicit env overrides and keep request payloads in `lib/robinhood.ts` traceable.
